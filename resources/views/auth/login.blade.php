...
<body
    class="font-body antialiased min-h-screen bg-indigo-50 dark:bg-gray-950"
    x-data="{
    ...
    <div class="flex min-h-screen">
        ...
        {{-- ════════════════════════════════════════════════════════════
             ...
             ════════════════════════════════════════════════════════════ --}}
        <section class="hidden lg:flex lg:w-[52%] signature-gradient relative overflow-hidden flex-col items-center justify-center p-10 xl:p-14">

            {{-- Orbes decorativos --}}
            <div class="pointer-events-none absolute -top-32 -left-32 h-[500px] w-[500px] rounded-full bg-white/10 blur-[130px]"></div>
            <div class="pointer-events-none absolute -bottom-24 -right-24 h-[420px] w-[420px] rounded-full bg-indigo-950/25 blur-[110px]"></div>
            <div class="pointer-events-none absolute top-1/2 left-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/5 blur-[80px]"></div>

            <div class="relative z-10 max-w-lg w-full">

                {{-- Logo --}}
                <div class="mb-8 flex items-center gap-4">
                    <div class="flex h-13 w-13 flex-shrink-0 items-center justify-center rounded-2xl bg-white/20 shadow-lg backdrop-blur-md">
                    ...
                    <h1 class="font-headline font-extrabold text-4xl tracking-tight text-white">
                ...
                {{-- Titular --}}
                <div class="space-y-5">
                    <h2 class="font-headline font-bold text-4xl leading-[1.1] tracking-tight text-white">
                ...
                <div class="mt-8 space-y-3">
                    @foreach ([
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl bg-white/15">
                ...
                <div class="mt-8 flex items-center gap-8 text-indigo-300/80">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-label text-xs font-semibold uppercase tracking-wider">256-bit Encryption</span>
                    </div>
                    <div class="flex items-center gap-2">
        ...
        {{-- ════════════════════════════════════════════════════════════
             ...
             ════════════════════════════════════════════════════════════ --}}
        <main class="relative flex w-full items-center justify-center bg-white px-6 py-8 dark:bg-gray-900 sm:px-12 sm:py-8 md:px-16 md:py-6 lg:w-[48%]">

            {{-- Toggle tema desktop --}}
            <div class="absolute right-6 top-6 hidden items-center gap-1 rounded-xl bg-slate-100 p-1 shadow-sm dark:bg-gray-800 md:flex">
                <button
                    type="button"
            ...
            <div class="w-full max-w-md space-y-5">
                ...
                <div class="flex items-center justify-between lg:hidden">
                    <div class="flex items-center gap-3">
                        <div class="flex h-9 w-9 items-center justify-center rounded-xl signature-gradient">
                        ...
                        <span class="font-headline font-bold text-xl text-indigo-600 dark:text-sky-400">
                            {{ config('app.name', 'Cronos') }}
                        </span>
                    </div>
                    {{-- Toggle tema móvil --}}
                ...
                <div class="space-y-2">
                    <h3 class="font-headline font-extrabold text-2xl tracking-tight text-slate-800 dark:text-gray-100">
                        Bienvenido de nuevo
                    </h3>
                ...
                {{-- ── Session status ── --}}
                @if (session('status'))
                    <div class="flex items-start gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3.5 text-sm text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300">
                ...
                <form
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex cursor-pointer items-center gap-2.5">
                            <input
                                ...
                                id="remember_me"
                                name="remember"
                                class="h-4 w-4 rounded border-slate-300 bg-white text-indigo-600 transition-all
                                       focus:ring-2 focus:ring-indigo-400/25
                                       dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-sky-400/25" />
                    ...
                    <button
                        ...
                        class="inline-flex w-full items-center justify-center gap-2 rounded-2xl px-6 py-3
                               signature-gradient text-white
                               font-headline font-bold text-sm
                               shadow-[0px_12px_32px_rgba(79,70,229,0.20)]
                               transition-all duration-200 active:scale-[0.98]
                               focus:outline-none focus:ring-2 focus:ring-indigo-500/40 dark:focus:ring-sky-400/40">
                ...
                <p class="text-center text-sm text-slate-500 dark:text-gray-400">
                    ¿Necesitas acceso?
                    <a href="#" class="font-semibold text-indigo-600 transition-colors hover:text-indigo-700 dark:text-sky-400 dark:hover:text-sky-300">
