...
{{--
    LIGHT : bg-indigo-50  — lavanda suave, mismo tono que el header (color de marca soft)
    DARK  : bg-gray-900   — mismo tono que el header (oscuro uniforme)
    El contenido (bg-white / dark:bg-gray-950) contrasta con el nav en ambos modos.
--}}
<div
